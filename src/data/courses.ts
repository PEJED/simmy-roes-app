...
export const courses: Course[] = [
    ...
    },
    {
        ...
        type: 'compulsory',
        is_flow_compulsory: true,
        description: "Υπολογισμός ηλεκτρικού πεδίου διατάξεων υψηλών τάσεων. Αλγόριθμοι προσομοίωσης ηλεκτρομαγνητικών 116 πεδίων υψηλών τάσεων με συγκεντρωμένα στοιχεία. Μερικές εκκενώσεις και διάσπαση σε αέρα, στερεά, υγρά και λοιπά αέρια μονωτικά. Οδεύοντα κύματα. Διατάξεις παραγωγής τάσεων και ρευμάτων δοκιμής. Μετασχηματιστές δοκιμής. Ανορθωτές. Διατάξεις παραγωγής υψηλών συνεχών και κρουστικών τάσεων, αποσβεννυμένων ταλαντώσεων και κρουστικών ρευμάτων. Κατασκευαστικά και λειτουργικά στοιχεία, ισοδύναμα κυκλώματα. Εκκενώσεις σε μονωτικά, παραγωγή τάσεων και ρευμάτων δοκιμής στο Εργαστήριο.",
    ...
    },
    {
        ...
        type: 'elective',
        is_flow_compulsory: false,
        description: "Συστήματα αερίων μονωτικών (GIS). Διακόπτες ισχύος και συστήματα αερίων μονωτικών GIS, μέθοδοι για τη σβέση του τόξου, διακόπτες ισχύος με μονωτικό αέριο εξαφθοριούχο θείο SF6, ενεργός ή ουδετέρα δεξαμενή, μονωτήρες στήριξης σε υποσταθμούς GIS, η επίδραση της ρύπανσης στους χώρους του εξαφθοριούχου θείου, υλικά μονωτήρων. Τεχνολογία κενού. Κατηγορίες κενού, εισαγωγή στην τεχνολογία εξαιρετικά υψηλού κενού, τρόποι μέτρησης χαμηλών πιέσεων, τύποι άντλησης, κατασκευαστικά υλικά, βασικές εφαρμογές, διακόπτες κενού μέσης τάσης. Η χρησιμοποίηση του τετραπολικού φίλτρου μαζών στον ποιοτικό έλεγχο των αερίων μονωτικών υλικών, εφαρμογή : καθαρό SF6. Στερεά μονωτικά υλικά υψηλών τάσεων. Ηλεκτρική πορσελάνη. Μονωτικό γυαλί. ‘Ινες γυαλιού συνδεδεμένες με ρηγίνη (RBGF). Πολυμερή. (Εφαρμογές, ενδύσεις – συμπήξεις). Ακροδέκτες και εμφυτεύσεις σε στερεούς μονωτήρες. Φαινόμενα μεταφοράς ηλεκτρονίων, εκπομπή πεδίου, ιονισμός πεδίου, φαινόμενο χιονοστιβάδας, αγωγιμότητα επαγόμενη δι’ ακτινοβολίας, θερμικώς διεγειρόμενα ρεύματα, αρνητική διαφορική αγωγιμότητα, διεπιφάνειες, συστήματα με ένα ή δύο είδη φορέων. Εργαστηριακές ασκήσεις.",
        professors: "Δε θα διδαχθεί κατά το ακαδημαϊκό έτος 2024-25.",
        lecture_hours: 2,
        lab_hours: 1
    },
    ...
    {
        id: 3047,
        title: "Μετρήσεις και Εφαρμογές Υψηλών Τάσεων",
        semester: 8,
        flow: "Ενέργεια",
        flow_code: "Z",
        ects: 6,
    ...
    {
        id: 3215,
        title: "Ηλεκτρομαγνητική Πρόωση και Ανάρτηση",
        semester: 8,
        flow: "Ενέργεια",
        flow_code: "Z",
        ects: 4,
        type: 'elective',
        is_flow_compulsory: false,
        description: "Γενικά. Ευθύγραμμοι κινητήρες (Linear motors). Ευθύγραμμες επαγωγικές μηχανές. Σύγχρονοι ευθύγραμμοι κινητήρες. Συστήματα ηλεκτρομαγνητικής ανάρτησης. Μαγνητοϋδροδυναμικές μηχανές. Ηλεκτρομαγνητικά τραίνα με μια ράγα (monorail). Ηλεκτρομαγνητικά τραίνα με μαγνητική ανάρτηση (maglev). Λοιπές εφαρμογές. Εργαστηριακές ασκήσεις.",
        professors: "Δε θα διδαχθεί κατά το ακαδημαϊκό έτος 2024-25.",
        lecture_hours: 2,
        lab_hours: 1
    },
    ...
    {
        id: 3354,
        title: "Ποιοτικός Έλεγχος Εξοπλισμού Βιομηχανικών Εγκαταστάσεων και Υλικών",
        semester: 9,
        flow: "Ενέργεια",
        flow_code: "Z",
        ects: 4,
    ...
    {
        id: 3202,
        title: "Προστασία Ηλεκτρικών Εγκαταστάσεων από Υπερτάσεις",
        semester: 9,
        flow: "Ενέργεια",
        flow_code: "Z",
        ects: 4,
    ...
    {
        id: 3339,
        title: "Συστήματα Ειδικών Ηλεκτρικών Κινητήρων",
        semester: 9,
        flow: "Ενέργεια",
        flow_code: "Z",
        ects: 4,
        type: 'elective',
        is_flow_compulsory: false,
        description: "Αρχές λειτουργίας των ειδικών κινητήρων: βηματικοί κινητήρες, κινητήρες universal, σερβοκινητήρες, ευθύγραμμοι κινητήρες, κινητήρες χωρίς ψήκτρες, ηλεκτροστατικοί κινητήρες, κεραμικοί κινητήρες, κινητήρες υπερηχητικού κύματος, κινητήρες πλαστικοποιημένου μαγνήτη. Τεχνικές ελέγχου συστημάτων ειδικών κινητήρων: διανυσματικός έλεγχος, ψηφιακός έλεγχος, έλεγχος υψηλής ταχύτητας. Συστήματα ελέγχου ειδικών κινητήρων: συστήματα ελέγχου σερβοκινητήρων, συστήματα ελέγχου βηματικών κινητήρων, σερβοσυστήματα με μικροϋπολογιστές. Εφαρμογές συστημάτων ειδικών κινητήρων σε: συστήματα πληροφορικής, ιατρικά μηχανήματα, συστήματα αυτοματισμού και ρομποτικής, συστήματα μεταφοράς κ.λπ. Εργαστηριακές ασκήσεις.",
        professors: "Δε θα διδαχθεί κατά το ακαδημαϊκό έτος 2024-25.",
        lecture_hours: 2,
        lab_hours: 2
    },
    ...
    {
        id: 3313,
        title: "Ανάλυση ΣΗΕ (Ασύμμετρες και Μεταβατικές Καταστάσεις)",
        semester: 8,
        flow: "Ενέργεια",
        flow_code: "E",
        ects: 6,
    ...
    {
        id: 3363,
        title: "Εποπτεία και Διαχείριση Ενεργειακών Συστημάτων",
        semester: 8,
        flow: "Ενέργεια",
        flow_code: "E",
        ects: 4,
    ...
    {
        id: 3227,
        title: "Αυτόματος Έλεγχος και Ευστάθεια ΣΗΕ",
        semester: 9,
        flow: "Ενέργεια",
        flow_code: "E",
        ects: 4,
    ...
    {
        id: 3325,
        title: "Διαχείριση Ενέργειας και Περιβαλλοντική Πολιτική",
        semester: 9,
        flow: "Ενέργεια",
        flow_code: "E",
        ects: 4,
    ...
    {
        id: 3235,
        title: "Οικονομική και Αξιόπιστη Λειτουργία ΣΗΕ",
        semester: 9,
        flow: "Ενέργεια",
        flow_code: "E",
        ects: 4,
...
,
    ...
    {
        id: 3331,
        title: "Επεξεργασία και Ανάλυση Ιατρικών Σημάτων",
        semester: 7,
        flow: "Βιοϊατρική",
        flow_code: "I",
        ects: 4,
    ...
    {
        id: 3245,
        title: "Εγκατάσταση, Διαχείριση και Ποιοτικός Έλεγχος Ιατρικών και Νοσοκομειακών Συστημάτων",
        semester: 9,
        flow: "Βιοϊατρική",
        flow_code: "I",
        ects: 4,
