...
export const courses: Course[] = [
    ...
    },
    {
        ...
        professors: "Ι. Γκόνος, Ε. Μαρινάκης, Π. Μπούρκας, Ν. Ηλία (Ε.ΔΙ.Π.), Ν. Κιμουλάκης (Ε.ΔΙ.Π.)",
        lecture_hours: 3,
        lab_hours: 1
    },
    {
    ...
    },
    {
        ...
        professors: "Δ. Ασκούνης, Γ. Μέντζας, Ε. Σπηλιώτης, Ι. Μακαρούνη (Ε.ΔΙ.Π.), Δ. Πανόπουλος (Ε.ΔΙ.Π.), Μ. Φλουρή (Ε.ΔΙ.Π.)",
        lecture_hours: 0,
        lab_hours: 4
    },
    {
