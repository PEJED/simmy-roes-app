  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="text-center max-w-2xl mx-auto">
        <h2 className="text-3xl font-bold text-gray-800 mb-3">Επιλογή Κατεύθυνσης</h2>
        <p className="text-gray-600 text-lg">
          Ξεκινήστε επιλέγοντας την ακαδημαϊκή κατεύθυνση που σας ενδιαφέρει για να δείτε τους διαθέσιμους συνδυασμούς ροών.
        </p>
      </div>
        ...
        {Object.entries(DIRECTION_INFO).map(([key, info]) => {
          ...
          return (
            <button
              ...
              className={`group relative p-8 rounded-2xl text-left transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl
                ${isSelected
            ...
            >
              ...
              <div className="mt-6 flex items-center text-sm font-semibold text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                Προβολή Συνδυασμών <span className="ml-2 transform group-hover:translate-x-1 transition-transform">&rarr;</span>
              </div>
            </button>
          );
        })}
